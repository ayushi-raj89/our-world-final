...
const OurWorldView = ({ onBack, active }) => {
  ...
  return (
    <div id="secret-screen" className="screen active">
      ...
      <div className={`secret-container glass-card ${showContent ? 'opacity-100' : 'opacity-0'}`} style={{ transition: 'opacity 1s ease' }}>
        ...
        <div className="secret-content">
          ...
          <div className="flex justify-center mt-6 opacity-40">
            <Sparkles className="w-5 h-5 text-[#dfb76c] animate-float" />
          </div>
        </div>
      </div>
    </div>
